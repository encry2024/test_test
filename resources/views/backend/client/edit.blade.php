...
@section ('title', __('labels.backend.clients.management') . ' | ' . __('labels.backend.clients.edit', ['client' => $client->name]))
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.clients.edit', ['client' => $client->name]) }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
